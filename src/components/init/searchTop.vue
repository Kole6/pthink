    ...
    <div class="search-frame">
      <div class="top-frame" v-for="(itemList,index) of search" :key="index">
        <div v-if="itemList.type=='input'">
          ...
          <div class="input">
            <el-input size="small" v-model="itemList.model" :placeholder="'请输入'+itemList.name"></el-input>
          </div>
        </div>
        ...
        <div v-else-if="itemList.type=='select'">
          ...
          <div class="input">
            <el-select size="small" v-model="itemList.model" :placeholder="'请选择'+itemList.name">
              <el-option
